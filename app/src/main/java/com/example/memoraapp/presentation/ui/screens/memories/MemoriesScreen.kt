...
import com.example.memoraapp.presentation.ui.components.buttons.CircleShapeExtendedFAB
import com.example.memoraapp.presentation.ui.components.cards.MemoryCardComponent
...
fun MemoriesScreenContent(
    ...
    Scaffold(
        ...
        topBar = {
            TopbarComponent(
                screenName = stringResource(R.string.scr_name_minhas_memorias),
                onBackClick = { onEvent(MemoriesScreenEvent.OnBackClick) })
        },
